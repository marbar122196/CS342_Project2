...
public void winningHands(Stage optionsStage) {
	...
	public Scene startNewGame(Stage primaryStage) {
		...
		buttonPlayerOne.setLayoutX();
		buttonPlayerOne.setLayoutY();

		//Player 1 contents VBox
		VBox contentsPlayerOne = new VBox(10, namePlayerOne, buttonPlayerOne);
		contentsPlayerOne.setLayoutX(250);
		contentsPlayerOne.setLayoutY(285);
		...
		buttonPlayerTwo.setLayoutX();
		buttonPlayerTwo.setLayoutY();

		//Player 2 contents Vboc
		VBox contentsPlayerTwo = new VBox(namePlayerOne);
		contentsPlayerTwo.setLayoutX(550);
		contentsPlayerTwo.setLayoutY(285);
